...
// db["Match"].hasOne(db["TeamParticipant"], { foreignKey: "game_id", as: "MatchTeamParticipant"  });
 //db['Account_bank'].belongsTo(db['Bank'], { foreignKey: "Bank", as: "bank_id"  });

//  db['Account_bank'].belongsTo(db['Bank'], {foreignKey : 'bank_id'});
//  db['Account_bank'].belongsTo(db['Server_apiscb'], {foreignKey : 'server_apiscb_id'});
//  db['Menu_backend'].belongsTo(db['Adminlogin'], {foreignKey : 'adminlogin_id', as: "Adminlogin"});
